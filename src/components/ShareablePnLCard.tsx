              ...
              {(data.entryPrice && data.exitPrice) && (
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="bg-white/5 rounded-2xl p-4 text-center border border-white/5">
                    <p className="text-white/40 text-lg md:text-xl font-bold uppercase tracking-wider mb-2">Entry Price</p>
                    <p className="text-5xl md:text-6xl font-bold font-mono text-white">
                      {formatCurrency(data.entryPrice, data.assetType)}
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-2xl p-4 text-center border border-white/5">
                    <p className="text-white/40 text-lg md:text-xl font-bold uppercase tracking-wider mb-2">Exit Price</p>
                    <p className="text-5xl md:text-6xl font-bold font-mono text-white">
